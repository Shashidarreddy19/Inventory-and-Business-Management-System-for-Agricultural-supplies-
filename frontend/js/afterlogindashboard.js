...
async function updateDashboardStats() {
    try {
        ...
        // Define endpoints
        const endpoints = {
            stock: `http://localhost:3001/api/stock?userId=${userId}`,
            suppliers: `http://localhost:3001/api/suppliers?userId=${userId}`,
            orders: `http://localhost:3001/api/orders?userId=${userId}`,
            customers: `http://localhost:3001/api/customers?userId=${userId}`,
            credits: `http://localhost:3001/api/credit?userId=${userId}`,
            sales: `http://localhost:3001/api/sales?userId=${userId}`
        };
...
async function updateStock(stockId) {
    try {
        ...
        const userId = localStorage.getItem('userId');
        const response = await fetch(`http://localhost:3001/api/stock/${stockId}`, {
            method: 'PUT',
            headers: {
