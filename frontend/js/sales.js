...
async function loadDailyStatistics() {
    try {
        ...
        const response = await fetch(`http://localhost:3001/api/sales/daily-stats?userId=${userId}&date=${today}`);
...
async function loadProducts() {
    try {
        ...
        const response = await fetch(`http://localhost:3001/api/stock?userId=${userId}`);
...
async function loadSalesHistory() {
    try {
        ...
        let url = `http://localhost:3001/api/sales`;
...
async function exportSalesReport() {
    try {
        ...
        const response = await fetch(
            `http://localhost:3001/api/sales/export?userId=${userId}&startDate=${startDate}&endDate=${endDate}`
        );
...
async function deleteSale(saleId) {
    try {
        ...
        const response = await fetch(`http://localhost:3001/api/sales/${parseInt(saleId)}`, {
            method: 'DELETE',
            headers: {
                'Content-Type': 'application/json',
                'userId': userId
...
async function archiveSale(saleId) {
    try {
        ...
        const response = await fetch(`http://localhost:3001/api/sales/${parseInt(saleId)}/archive`, {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json',
                'userId': userId
...
async function unarchiveSale(saleId) {
    try {
        ...
        const response = await fetch(`http://localhost:3001/api/sales/${saleId}/unarchive`, {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json',
                'userId': userId
